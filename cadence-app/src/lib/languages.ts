...
export const LANGS: Record<string, LanguageData> = {
  "es": {
    ...
    "chapters": [
      ...
      ,{
        "chapterTitle": "Chapter 13 · Apartment Hunting",
        "lessonTitle": "Renting an Apartment",
        "goalTitle": "Build it: rent an apartment",
        "goalLine": "Ask a landlord about apartment details and rent.",
        "goalShort": "rent an apartment",
        "scenario": "freetalk",
        "partnerName": "Señor Ruiz",
        "partnerInitial": "R",
        "partnerRole": "landlord",
        "partnerPlace": "an apartment building",
        "scenarioTitle": "Meeting the Landlord",
        "scenarioSub": "Roleplay · asking about an apartment",
        "lessonPromptEn": "How much is the rent per month?",
        "lessonHint": "Use 'alquiler' for rent.",
        "bank": [
          "¿Cuánto es",
          "el alquiler",
          "al mes?",
        ...
        "correct": [0, 1, 2],
        "lessonCorrectTitle": "¡Bienvenido a casa! 🎉",
        "lessonCorrectBody": "In Spain, it is common to ask if the rent includes community fees ('gastos de comunidad').",
        "lessonWrongBody": "Ask 'How much is', add the word for rent, then 'per month'.",
        "cultureCaption": "Apartment buildings in Madrid",
        "cultureTitle": "Pisos",
        "cultureBody": "In Spain, an apartment is typically called a 'piso'. Most city dwellers live in pisos rather than detached houses.",
        "culturePhrase": "“¿Está incluido el internet?” — asking if internet is included in the price.",
        "milestoneTitle": "You can now handle apartment rentals.",
        "convo": [
          { "who": "p", "n": "Hola, pase. Este es el piso.", "en": "Hello, come in. This is the apartment." },
          { "who": "u", "n": "Es muy bonito. ¿Cuánto es el alquiler al mes?", "fb": "Great question, straight to the point!" },
          { "who": "p", "n": "Son ochocientos euros al mes.", "en": "It is eight hundred euros per month." },
          { "who": "u", "n": "¿Está amueblado?", "fb": "Very important to ask when renting." },
          { "who": "p", "n": "Sí, viene con todos los muebles.", "en": "Yes, it comes with all the furniture." }
        ],
        "debrief": [
          { "title": "Piso vs Apartamento", "body": "'Piso' is the standard word in Spain. 'Apartamento' usually refers to a smaller or vacation rental." },
          { "title": "Amueblado", "body": "Furnished. Unfurnished is 'sin amueblar'." }
        ],
        "grammarMini": "ser vs estar (location)",
        "grammarTitle": "“Estar” for Location",
        "grammarIntro": "Use 'estar' to talk about where an apartment is.",
        "gTermA": "Está cerca",
        "gDescA": "It is close",
        "gExA": "El piso está cerca del metro.",
        "gTermB": "Está lejos",
        "gDescB": "It is far",
        "gExB": "Está lejos del centro.",
        "clip": "House Hunting in Spain",
        "podcast": "Vivir en España — ep. 1",
        "article": "A Guide to Renting Your First Piso",
        "reader": [
          { "t": "Buscar un " },
          { "w": "piso", "d": "apartment" },
          { "t": " requiere paciencia. Hay que preguntar por el " },
          { "w": "alquiler", "d": "rent" },
          { "t": " y ver si el " },
          { "w": "barrio", "d": "neighborhood" },
          { "t": " es seguro." }
        ],
        "reviewWord": "piso",
        "reviewSource": "from your landlord meeting, today",
        "reviewMeaning": "apartment"
      },
      {
        "chapterTitle": "Chapter 14 · Professional Life",
        "lessonTitle": "The Job Interview",
        "goalTitle": "Build it: answer interview questions",
        "goalLine": "Discuss your past experience with a hiring manager.",
        "goalShort": "job interview",
        "scenario": "interview",
        "partnerName": "Directora Fernández",
        "partnerInitial": "F",
        "partnerRole": "hiring manager",
        "partnerPlace": "an office",
        "scenarioTitle": "At the Job Interview",
        "scenarioSub": "Roleplay · discussing work experience",
        "lessonPromptEn": "I have worked in marketing for three years.",
        "lessonHint": "Use 'He trabajado' (I have worked).",
        "bank": [
          "He trabajado",
          "en marketing",
          "por tres años",
        ...
        "correct": [0, 1, 2],
        "lessonCorrectTitle": "¡Estás contratado! 🎉",
        "lessonCorrectBody": "In Spain, use the present perfect ('he trabajado') to talk about past experiences that are relevant now.",
        "lessonWrongBody": "Combine 'I have worked', the field, and the duration.",
        "cultureCaption": "A business district in Madrid",
        "cultureTitle": "Formal 'Usted'",
        "cultureBody": "In job interviews, it is crucial to use 'usted' (the formal 'you') unless the interviewer explicitly tells you to use 'tú'.",
        "culturePhrase": "“Hábleme de usted” — Tell me about yourself.",
        "milestoneTitle": "You can discuss your professional background.",
        "convo": [
          { "who": "p", "n": "Buenos días, hábleme de su experiencia.", "en": "Good morning, tell me about your experience." },
          { "who": "u", "n": "He trabajado en marketing por tres años.", "fb": "Excellent. Professional and direct." },
          { "who": "p", "n": "¿Por qué le interesa este puesto?", "en": "Why are you interested in this position?" },
          { "who": "u", "n": "Creo que puedo aportar mucho a la empresa.", "fb": "Great use of 'aportar' (to contribute)." },
          { "who": "p", "n": "Me parece muy bien.", "en": "That sounds very good." }
        ],
        "debrief": [
          { "title": "Aportar", "body": "A great professional verb meaning 'to contribute' or 'bring to the table'." },
          { "title": "Por tres años", "body": "You can also use 'durante tres años' to express duration." }
        ],
        "grammarMini": "present perfect",
        "grammarTitle": "The Present Perfect",
        "grammarIntro": "Used for past actions connected to the present.",
        "gTermA": "He",
        "gDescA": "I have...",
        "gExA": "He trabajado mucho.",
        "gTermB": "Has",
        "gDescB": "You have...",
        "gExB": "¿Has terminado?",
        "clip": "Mastering the Interview",
        "podcast": "Negocios Hoy — ep. 12",
        "article": "CV Etiquette in Spain",
        "reader": [
          { "t": "En una " },
          { "w": "entrevista", "d": "interview" },
          { "t": " de trabajo, es importante hablar de tus " },
          { "w": "habilidades", "d": "skills" },
          { "t": " y mostrar interés en el " },
          { "w": "puesto", "d": "position" },
          { "t": "." }
        ],
        "reviewWord": "puesto",
        "reviewSource": "from your job interview, today",
        "reviewMeaning": "job position"
      },
      {
        "chapterTitle": "Chapter 15 · Expressing Opinions",
        "lessonTitle": "A Friendly Debate",
        "goalTitle": "Build it: state your opinion",
        "goalLine": "Agree or disagree with an opinion.",
        "goalShort": "state an opinion",
        "scenario": "debate",
        "partnerName": "Mateo",
        "partnerInitial": "M",
        "partnerRole": "debate partner",
        "partnerPlace": "a university café",
        "scenarioTitle": "The Great Debate",
        "scenarioSub": "Roleplay · expressing agreement or disagreement",
        "lessonPromptEn": "I don't agree with you.",
        "lessonHint": "Use 'No estoy de acuerdo'.",
        "bank": [
          "No estoy",
          "de acuerdo",
          "contigo",
        ...
        "correct": [0, 1, 2],
        "lessonCorrectTitle": "¡Buen punto! 🎉",
        "lessonCorrectBody": "In Spanish, you 'are' in agreement (estar de acuerdo), you don't 'do' agreement.",
        "lessonWrongBody": "Combine 'I am not', 'in agreement', and 'with you'.",
        "cultureCaption": "Students debating in Salamanca",
        "cultureTitle": "Direct Communication",
        "cultureBody": "Spanish culture favors very direct communication. Disagreeing openly ('No estoy de acuerdo') is normal and not considered rude among friends.",
        "culturePhrase": "“¡Qué va!” — No way! / Nonsense!",
        "milestoneTitle": "You can argue and debate in Spanish.",
        "convo": [
          { "who": "p", "n": "Creo que vivir en la ciudad es mejor que en el campo.", "en": "I think living in the city is better than the countryside." },
          { "who": "u", "n": "No estoy de acuerdo contigo.", "fb": "A strong, clear disagreement." },
          { "who": "p", "n": "¿Por qué no? En la ciudad hay de todo.", "en": "Why not? In the city there is everything." },
          { "who": "u", "n": "Sí, pero en mi opinión hay demasiado ruido.", "fb": "Great use of 'en mi opinión'." },
          { "who": "p", "n": "Bueno, en eso tienes razón.", "en": "Well, you are right about that." }
        ],
        "debrief": [
          { "title": "Tener razón", "body": "In Spanish, you don't 'are' right, you 'have' reason (tener razón)." },
          { "title": "Contigo", "body": "A special word combining 'con' (with) and 'ti' (you). 'With me' is 'conmigo'." }
        ],
        "grammarMini": "creer que",
        "grammarTitle": "“Creer que” vs “No creer que”",
        "grammarIntro": "Expressing belief often triggers the subjunctive.",
        "gTermA": "Creo que",
        "gDescA": "I believe that (indicative)",
        "gExA": "Creo que es verdad.",
        "gTermB": "No creo que",
        "gDescB": "I don't believe that (subjunctive)",
        "gExB": "No creo que sea verdad.",
        "clip": "University Debates",
        "podcast": "Opiniones — ep. 3",
        "article": "The Art of Conversation in Spain",
        "reader": [
          { "t": "En España, es común " },
          { "w": "debatir", "d": "to debate" },
          { "t": " con amigos sobre política o deportes. Si no estás " },
          { "w": "de acuerdo", "d": "in agreement" },
          { "t": ", simplemente dilo." }
        ],
        "reviewWord": "razón",
        "reviewSource": "from your debate, today",
        "reviewMeaning": "reason/right"
      }
]
  },
  "fr": {
